    ...
    return (
        <div style={{ fontFamily: font.sans, background: C.bg, paddingBottom: 120 }}>
            ...
            <div style={{ maxWidth: 760, margin: '0 auto', padding: '60px 24px 0' }}>
                ...
                <Section title="5. Pricing and Billing" reduceMotion={reduceMotion}><p>Taxed offers a one-time lifetime purchase for <strong>$0.99 (USD)</strong>. After payment, you receive permanent full access to all features with no recurring charges.</p><p style={{ marginTop: 10 }}><strong>Refund Policy:</strong> Due to the nature of instant digital access, charges are generally non-refundable except where required by law. For technical billing issues, contact <strong>support@taxedhq.com</strong>.</p></Section>
