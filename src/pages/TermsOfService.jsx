    ...
    return (
        <div style={{ fontFamily: font.sans, background: C.bg, paddingBottom: 120 }}>
            ...
            <div style={{ maxWidth: 760, margin: '0 auto', padding: '60px 24px 0' }}>
                ...
                <Section title="5. One-Time Purchase and Refund Policy" reduceMotion={reduceMotion}><p>Access to Taxed's full feature set is available for a one-time purchase of <strong>$29.99</strong>. This grants you lifetime access to the platform as it exists at the time of purchase and all future non-premium updates.</p><p style={{ marginTop: 10 }}><strong>Refund Policy:</strong> Due to the immediate nature of digital access, all sales are final. We do not offer refunds after purchase. If you experience a technical issue, please contact us at <strong>support@taxedhq.com</strong> within 7 days of purchase.</p></Section>
