    ...
    return (
        <div style={{ fontFamily: font.sans, background: C.bg, paddingBottom: 120 }}>
            ...
            <div style={{ maxWidth: 760, margin: '0 auto', padding: '60px 24px 0' }}>
                ...
                <Section title="5. Subscription Plans and Billing" reduceMotion={reduceMotion}><p>Taxed offers subscription access tiers: <strong>Full Access ($4.99/month)</strong> and <strong>Pro + AI ($9.99/month)</strong>. Both plans include a minimum 3-month commitment period from activation.</p><p style={{ marginTop: 10 }}><strong>Billing and Cancellation:</strong> Subscriptions renew monthly. You may cancel after the minimum commitment period through your billing portal or by contacting <strong>support@taxedhq.com</strong>.</p><p style={{ marginTop: 10 }}><strong>Refund Policy:</strong> Charges are generally non-refundable except where required by law. For technical billing issues, contact <strong>support@taxedhq.com</strong>.</p></Section>
